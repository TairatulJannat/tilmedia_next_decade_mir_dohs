                ...
                <form id="save_info" autocomplete="off">
                    ...
                    <div class="card-body">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="date" name="end_date" class="form-control" id="end_date" placeholder="Enter end date " autocomplete="off">
                            <span id="error_end_date" class="text-danger error_field"></span>
                        </div> --}}
                    </div>
