                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                                <b>Address</b> <a class="float-right">{{$customer->address ? $customer->address : ''}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Payment Balance</b>
                            ...
                            <li class="list-group-item">
                                <b>Package Name</b> <a class="float-right">{{$customerPackage ? $customerPackage->name : ''}}</a>
                            </li>

                            <li class="list-group-item bg-secondary p-2">
                                <b>Created By</b> <a class="float-right">{{$created_by? $created_by->name : ''}}</a>
                            </li>
                        </ul>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row mb-0">
                                                <div class="col-md-8 offset-md-4">
                                                    <a href="{{route('customer_reset_password', $customer->id)}}" class="btn btn-primary">
                                                        Reset Password
                                                    </a>
                                                </div>
