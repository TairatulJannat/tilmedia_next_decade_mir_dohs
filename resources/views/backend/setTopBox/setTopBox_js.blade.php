<script>
    $(function() {
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: {
                url: "{{ url('admin/search_setTopBox') }}",
                type: 'POST',
                data: function(d) {
    ...
    function delete_data(id) {
        swal({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{url('admin/setTopBox_delete')}}/" + id,
    ...
    $('#save_info').off().on('submit', function(event) {
        event.preventDefault();
        $.ajax({
            url: "{{url('admin/setTopBox_create')}}",
            type: "POST",
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "{{url('admin/setTopBox_edit')}}/" + id,
            type: "GET",
            success: function(response) {
                if (response) {
    ...
    $('#update_form').off().on('submit', function(event) {
        event.preventDefault();
        $.ajax({
            url: "{{url('admin/setTopBox_update')}}",
            type: "POST",
            data: $(this).serializeArray(),
            success: function(response) {
                if (response) {
