<script>
    ...
    function delete_data(id) {
        swal({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'get',
                    url: "<?php echo e(url('admin/customer_delete')); ?>/" + id,
    ...
    $('#save_info').off().on('submit', function(event) {
        event.preventDefault();
        $.ajax({
            url: "<?php echo e(url('admin/customer_create')); ?>",
            type: "POST",
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/customer_edit')); ?>/" + id,
            type: "GET",
            success: function(response) {
                if (response) {
    ...
    function package(id) {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/customer_package_assign')); ?>/" + id,
            type: "GET",
            success: function(response) {
                if (response) {
    ...
    function SetTopBox(id) {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/customer_setTopBox_assign')); ?>/" + id,
            type: "GET",
            success: function(response) {
                if (response) {
                    console.log(response);
...
>>>>>>> bf146c8 (settopbox update)
    ...
    $('#customer_settopbox_form').off().on('submit', function(event) {
        event.preventDefault();
        $.ajax({
            url: "<?php echo e(url('admin/customer_settopbox_assign_perform')); ?>",
            type: "POST",
            data: $(this).serializeArray(),
            success: function(response) {
                if (response.status) {
    ...
    $('#customer_package_form').off().on('submit', function(event) {
        event.preventDefault();
        $.ajax({
            url: "<?php echo e(url('admin/customer_package_assign_perform')); ?>",
            type: "POST",
            data: $(this).serializeArray(),
            success: function(response) {
                if (response.status) {
    ...
    $('#update_form').off().on('submit', function(event) {
        event.preventDefault();
        $.ajax({
            url: "<?php echo e(url('admin/customer_update')); ?>",
            type: "POST",
            data: $(this).serializeArray(),
            success: function(response) {
                if (response.success) {
...
</script><?php /**PATH C:\xampp\htdocs\tilmedia_next_decade_mir_dohs\resources\views/backend/customer/customer_js.blade.php ENDPATH**/ ?>